...
<pre style="white-space: pre-wrap;">
apt install ilorest python3-sushy redfishtool python3-pyipmi python3-pyghmi prometheus-ipmi-exporter openipmi nut-ipmi ipmiutil ipmitool freeipmi freeipmi-tools freeipmi-ipmiseld freeipmi-bmc-watchdog freeipmi-ipmidetect libipmimonitoring6
</pre>
